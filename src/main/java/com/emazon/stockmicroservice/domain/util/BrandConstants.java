...
public final class BrandConstants {
    ...
    public BrandConstants() { throw new IllegalStateException("Utility class"); }
    public enum Field {
        NAME,
        DESCRIPTION
    }
    ...
    public static final String DESCRIPTION_OVERSIZED_MESSAGE = "Field 'description' cannot be longer than 120 characters";
